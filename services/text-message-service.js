...
module.exports = class TextMessageService {
    ...
    send(sender, content, receivers, callback) {
        ...
        client.post('https://sms.comtele.com.br/api/v2/send', args, function (data, response) {
            callback(data);
        });
    }
    ...
    schedule(sender, content, scheduleDate, receivers, callback) {
        ...
        client.post('https://sms.comtele.com.br/api/v2/schedule', args, function (data, response) {
            callback(data);
        });
    }
    ...
    getDetailedReport(startDate, endDate, deliveryStatus, callback) {
        ...
        client.get('https://sms.comtele.com.br/api/v2/detailedreporting', args, function (data, response) {
            callback(data);
        });
    }
    ...
    getConsolidatedReport(startDate, endDate, groupType, callback) {
        ...
        client.get('https://sms.comtele.com.br/api/v2/consolidatedreporting', args, function (data, response) {
            callback(data);
        });
    }
